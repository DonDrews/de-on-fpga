...
namespace eval ::optrace {
  variable script "/home/donovan/deon_fpga/deon_fpga.runs/synth_1/bram_loader.tcl"
...
set_property used_in_implementation false [get_files /home/donovan/deon_fpga/deon_fpga.srcs/constrs_1/new/constr.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top bram_loader -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef bram_loader.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file bram_loader_utilization_synth.rpt -pb bram_loader_utilization_synth.pb"
